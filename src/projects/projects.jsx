...
const Projects = () => (
    <div id='projectsection' className='projects'>
        <div className='cards container'>
            <a target='_blank' rel="noreferrer" href="https://www.behance.net/abhishekyadav29"><div className='card'>
                ...
                <a target='_blank' rel="noreferrer" href="https://www.behance.net/abhishekyadav29"><FaArrowCircleRight className='arrow' /></a>
            </div></a>
            <a target='_blank' rel="noreferrer" href="https://github.com/abhii6700"><div className='card'>
                <BiCodeBlock className='project-icon' />
                <h2>DEVELOPMENT</h2>
                <p>My projects are based on HTML, CSS, SASS, JavaScript and React JS.</p>
                <a target='_blank' rel="noreferrer" href="https://github.com/abhii6700"><FaArrowCircleRight className='arrow' /></a>
            </div></a>
            <a target='_blank' rel="noreferrer" href="https://www.instagram.com/__abhishek.yadav__/"><div className='card'>
